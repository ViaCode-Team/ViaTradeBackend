...
public class CamelCaseParameterFilter : IOperationFilter
{
	public void Apply(OpenApiOperation operation, OperationFilterContext context)
	{
		...
		foreach (var parameter in operation.Parameters)
		{
			...
			var apiParameter = context.ApiDescription.ParameterDescriptions.FirstOrDefault(p =>
			...
			if (!hasExplicitName && !string.IsNullOrEmpty(openApiParameter.Name))
				openApiParameter.Name =
					JsonNamingPolicy.CamelCase.ConvertName(openApiParameter.Name) ?? openApiParameter.Name;
		}
	}
}
