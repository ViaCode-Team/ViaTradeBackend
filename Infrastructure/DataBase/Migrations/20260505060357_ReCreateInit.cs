...
public partial class ReCreateInit : Migration
{
	...
	protected override void Up(MigrationBuilder migrationBuilder)
	{
			...
			{
				{
					1,
					81,
					"Базовая стратегия следования биржевому тренду инструмента. Минамальный риск, редкие сигналы.",
					"1-3 недели",
					"Стратегия исключительно для слелования тренду",
					"Анализ длительного времение гшрафика для подтвержеденгия движдениея",
				...
				},
				{
					...
					"Test",
					"3 раза в месяц",
					"Как по кайфу так и используй",
				},
			}
		);

		migrationBuilder.CreateIndex(name: "IX_Notes_TradeCodeId", table: "Notes", column: "TradeCodeId");

		migrationBuilder.CreateIndex(name: "IX_Notes_TradeStrategyId", table: "Notes", column: "TradeStrategyId");
		...
		migrationBuilder.CreateIndex(name: "IX_Trades_TradeCodeId", table: "Trades", column: "TradeCodeId");

		migrationBuilder.CreateIndex(name: "IX_Trades_TradeTypeId", table: "Trades", column: "TradeTypeId");

		migrationBuilder.CreateIndex(name: "IX_Trades_UserId", table: "Trades", column: "UserId");
		...
		migrationBuilder.CreateIndex(name: "IX_TradeTypes_Name", table: "TradeTypes", column: "Name", unique: true);
	...
	protected override void Down(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.DropTable(name: "UserStrategyTradeCodes");

		migrationBuilder.DropTable(name: "UserTradeCode");

		migrationBuilder.DropTable(name: "UserTradeNote");

		migrationBuilder.DropTable(name: "UserTradeStrategies");

		migrationBuilder.DropTable(name: "NoteTypes");

		migrationBuilder.DropTable(name: "TradeTypes");

		migrationBuilder.DropTable(name: "TradeCodes");

		migrationBuilder.DropTable(name: "TradeStrategies");
