...
namespace Infrastructure.Migrations
{
	...
	public partial class AddCreatedAt : Migration
	{
		...
		{
			migrationBuilder.DropIndex(name: "IX_TradeReminds_Id", table: "TradeReminds");
		...
		{
			migrationBuilder.DropColumn(name: "CreatedAt", table: "UserTradeStrategies");

			migrationBuilder.DropColumn(name: "CreatedAt", table: "UserTradeCode");

			migrationBuilder.DropColumn(name: "CreatedAt", table: "UserStrategyTradeCodes");

			migrationBuilder.DropColumn(name: "CreatedAt", table: "Users");

			migrationBuilder.DropColumn(name: "CreatedAt", table: "TradeTypes");

			migrationBuilder.DropColumn(name: "CreatedAt", table: "TradeStrategies");

			migrationBuilder.DropColumn(name: "IsActive", table: "TradeStrategies");

			migrationBuilder.DropColumn(name: "CreatedAt", table: "Trades");

			migrationBuilder.DropColumn(name: "CreatedAt", table: "TradeReminds");

			migrationBuilder.DropColumn(name: "CreatedAt", table: "TradeCodes");

			migrationBuilder.DropColumn(name: "CreatedAt", table: "Notes");
