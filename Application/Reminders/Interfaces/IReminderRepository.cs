...
public interface IReminderRepository : IRepository<Reminder>
{
	...
	Task<PagedResult<Reminder>> GetByUserPagedAsync(int userId, PaginationRequest paginationRequest, ReminderSortRequest? sortRequest = null, CancellationToken ct = default);
	Task<PagedResult<Reminder>> GetByUserAndTradeCodePagedAsync(int userId, int tradeCodeId, PaginationRequest paginationRequest, ReminderSortRequest? sortRequest = null, CancellationToken ct = default);
