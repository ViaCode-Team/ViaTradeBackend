...
public interface ITradeService
{
	...
	Task<PagedResult<TradeDto>> GetByUserPagedAsync(int userId, DateTime? startDate, DateTime? endDate, TradeSignal? tradeSignal, PaginationRequest paginationRequest, CancellationToken cancellationToken);
