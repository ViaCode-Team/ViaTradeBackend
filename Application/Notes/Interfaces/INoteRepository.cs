...
public interface INoteRepository : IRepository<Note>
{
	...
	Task<Note> GetByTargetAsync(int id, int userId, NoteType noteType, CancellationToken ct);
	...
	Task<Note?> FindByTargetAsync(int userId, int relatedId, NoteType noteType, CancellationToken ct);
}
